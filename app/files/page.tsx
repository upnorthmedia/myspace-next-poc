...
export default function Files() {
    ...
    return (
<div>
        <h1 className="mt-2 text-3xl font-bold text-white sm:text-4xl ">Files</h1>
        <p className="text-base font-semibold leading-7 text-indigo-200">3D Printed Firearms</p>
        <h2 className="pt-10 text-xl">Latest File Drops</h2>
