  ...
  return (
    <div>
      ...
      <form onSubmit={updateUser}>
        <label className="pt-4 block mb-2 text-sm font-medium text-gray-900 dark:text-white" htmlFor="name">Name</label>
...
<label className="pt-4 block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bio</label>
<textarea id="bio" rows={4} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" defaultValue={user?.bio ?? ''}></textarea>
        ...
        <input type="text" id="image" aria-describedby="helper-text-explanation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" defaultValue={user?.image ?? ''} />
        <button className="inline-flex items-center px-3 mt-4 py-2 text-sm font-medium text-center text-white hover:bg-indigo-200 hover:text-black rounded-md bg-indigo-600 focus:ring-4 focus:outline-none focus:ring-blue-300" type="submit">
                Save
            </button>
      </form>
    </div>
